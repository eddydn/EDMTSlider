...
import edmt.dev.edmtslider.Animations.BaseAnimationInterface;
import edmt.dev.edmtslider.Indicators.PagerIndicator;
import edmt.dev.edmtslider.SliderTypes.BaseSliderView;
import edmt.dev.edmtslider.Transformer.AccordionTransformer;
import edmt.dev.edmtslider.Transformer.BackgroundToForegroundTransformer;
import edmt.dev.edmtslider.Transformer.BaseTransformer;
import edmt.dev.edmtslider.Transformer.CubeInTransformer;
import edmt.dev.edmtslider.Transformer.DefaultTransformer;
import edmt.dev.edmtslider.Transformer.DepthPageTransformer;
import edmt.dev.edmtslider.Transformer.FadeTransformer;
import edmt.dev.edmtslider.Transformer.FlipHorizontalTransformer;
import edmt.dev.edmtslider.Transformer.FlipPageViewTransformer;
import edmt.dev.edmtslider.Transformer.ForegroundToBackgroundTransformer;
import edmt.dev.edmtslider.Transformer.RotateDownTransformer;
import edmt.dev.edmtslider.Transformer.RotateUpTransformer;
import edmt.dev.edmtslider.Transformer.StackTransformer;
import edmt.dev.edmtslider.Transformer.TabletTransformer;
import edmt.dev.edmtslider.Transformer.ZoomInTransformer;
import edmt.dev.edmtslider.Transformer.ZoomOutSlideTransformer;
import edmt.dev.edmtslider.Transformer.ZoomOutTransformer;
import edmt.dev.edmtslider.Tricks.FixedSpeedScroller;
import edmt.dev.edmtslider.Tricks.InfinitePagerAdapter;
import edmt.dev.edmtslider.Tricks.InfiniteViewPager;
import edmt.dev.edmtslider.Tricks.ViewPagerEx;
